    ...
    <Container>
      <Grid container spacing={3} alignItems="center">
        ...
        <Grid item xs={12} md={6} lg={4}>
          <Button onClick={() => {
            handleChange('Medic_Date', new Date().toLocaleTimeString('en-US'))
            handleChange('Medic_Time', new Date().toLocaleTimeString('en-US'))
          }}
            fullWidth
            variant="outlined"
          >Medication Now</Button>
        </Grid>
        <Grid item xs={12}>
        ...
        <Grid item xs={12}>
          <FormControl fullWidth size="small">
            ...
            <Select
              ...
              onChange={(e) => handleChange('Effect_on_Patient', e.target.value)}
            >

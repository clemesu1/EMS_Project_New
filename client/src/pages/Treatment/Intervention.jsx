...
const procedureTypes = [
  ...
  "MAST",
  "Emergency rapid extrication",
  "Physical restraint",
  "Other",
];

const airwayClearedDevices = [
  "Suction",
  "Heimlich maneuver",
  "Laryngoscopy/Magill forceps",
];
const airwayPatencyDevices = [
...
const spinalImmobilizationDevices = [
  "Cervical collar",
  "Long spine board",
  "Head immobilizer",
  "KED",
...
const extremityImmobilizationDevices = [
  "Commercial extremity immobilization device",
  "Improvised extremity immobilization device",
  "Traction splint",
  "MAST",
  "Sling",
];
const bleedingControlDevices = [
  "Dressing",
  "Direct pressure",
  "Pressure points",
  "Tourniquet",
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={6} lg={4}>
              <Stack spacing={2}>
                ...
                <FormControl fullWidth size="small">
                  <InputLabel id="device-method-label">
                    Device / Method
                  </InputLabel>
                  <Select
                    ...
                    onChange={(e) =>
                      handleChange("Device_Method", e.target.value)
                    }
                  >
          ...
          <Grid container spacing={3}>
            ...
            <Grid item container spacing={1} xs={12} md={4}>
              ...
              <Grid item xs={6}>
                <TextField
                  ...
                  onChange={(e) =>
                    handleChange("Dosage_Amount", e.target.value)
                  }
                />
              </Grid>
              <Grid item xs={6}>
                <FormControl fullWidth size="small">
                  ...
                  <Select
                    ...
                    onChange={(e) =>
                      handleChange("Dosage_Unit", e.target.value)
                    }
                  >
            ...
            <Grid item xs={12} md={6}>
              <Stack spacing={2}>
                ...
                <FormControl fullWidth size="small">
                  <InputLabel id="treatment-outcome-label">
                    Treatment Outcome
                  </InputLabel>
                  <Select
            ...
            <Grid item xs={12} md={6} alignItems="flex-start">
              <Stack spacing={2}>
                <FormControl fullWidth size="small">
                  <InputLabel id="admin-route-label">
                  ...
                  <Select
                    ...
                    onChange={(e) =>
                      handleChange("Admin_Route", e.target.value)
                    }
                  >
                    {renderAdminRoutes()}
                  </Select>

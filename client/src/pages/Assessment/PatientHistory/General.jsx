...
import {
  setPatientHistory,
  toggleBodySystemItem,
} from "../../../features/patientHistory";
import {
  Checkbox,
  FormControl,
  FormControlLabel,
...
const General = () => {
  ...
  const handleChange = (name, value) =>
    dispatch(setPatientHistory({ name, value }));
      ...
      <Grid container spacing={3}>
                ...
                {bodySystems.map((item, index) => (
                  <FormControlLabel
                    ...
                    control={
                      <Checkbox
                        checked={
                          patientHistory.G_BodySystem.indexOf(item) !== -1
                        }
        ...
        <Grid item xs={12} md={6}>
          <DatePicker
            ...
            onChange={(date) =>
              handleChange("G_Inj_Date", date.toString())
            }
            renderInput={(params) => (
        ...
        <Grid item xs={12} md={6}>
          <FormControl fullWidth size="small">
            <InputLabel id="g-pt-condi-dest-label">
        ...
        <Grid item xs={12} md={10}>
          <FormControl fullWidth size="small">
            <InputLabel id="g-susp-intoxi-label">
        ...
        <Grid item xs={12} md={2}>
          <FormControlLabel
            control={
              <Checkbox
                checked={patientHistory.G_DNR_Order}
                name="G_DNR_Order"
                onChange={(e) => handleChange("G_DNR_Order", e.target.checked)}
              />
            }
            label="DNR Order"
          />

		...
		<Grid container spacing={3}>
			<Grid container item spacing={3} xs={12}>
				<Grid item xs={12} md={4}>
					<Autocomplete
						...
						renderInput={(params) => <TextField {...params} size="small" label="Service Code" />}
			...
			<Grid item xs={12}>
				<Paper variant="outlined" sx={{ p: 2, w: '100%' }}>
					<Typography color="textSecondary" gutterBottom sx={{ mb: 2 }}>Incident Location</Typography>
					<Grid container spacing={2}>
						...
						<Grid item xs={12} md={6} lg={3} sx={{ display: { xs: 'none', md: 'block' } }}>
							<Button onClick={handleSameAddress} fullWidth variant="outlined">Same as Patient Address</Button>
						</Grid>
						<Grid item xs={12} md={4}>
							<TextField
								label="City"
					...
					<Stack spacing={3}>
						...
						<FormControl size="small" fullWidth>
							...
							<Select
								...
								onChange={(e) => handleChange('Scene_Facility_Code', e.target.value)}
			...
			<Grid item xs={12}>
				<Paper variant="outlined" sx={{ p: 2, w: '100%' }}>
					<Typography color="textSecondary" gutterBottom sx={{ mb: 2 }}>Destination Location</Typography>
					<Grid container spacing={2}>
						<Grid item xs={12} md={6}>
							<FormControl fullWidth size="small">
			...
			<Grid item xs={12} md={6}>
				<Paper variant="outlined" sx={{ p: 2, w: '100%' }}>
					<Typography color="textSecondary" gutterBottom>Service Payment</Typography>
